  ...
  <section class="todoapp">
			...
			<footer class="footer">
				...
				<ul class="filters">
					...
					<li>
						<a :class="{selected:todolist.visibility==='active'}" @click="todolist.changeVisibility('active')">Active</a>
					</li>
					<li>
						<a :class="{selected:todolist.visibility==='completed'}" @click="todolist.changeVisibility('completed')">Completed</a>
					</li>
				</ul>
